  ...
  var q = /\s*([\-\w ]+)[\s\/\:]([\d_]+\b(?:[\-\._\/]\w+)*)/, r = /([\w\-\.]+[\s\/][v]?[\d_]+\b(?:[\-\._\/]\w+)*)/g,
    ...
    x = /(\bxbox\b|\bplaystation\b|\bnintendo\s+\w+)/, k = {
      parse: function (b, d) {
        ...
        if (a.applewebkit) a.webkit = a.applewebkit, delete a.applewebkit, a.opr && (a.opera = a.opr, delete a.opr, delete a.chrome), a.safari && (a.chrome || a.crios || a.fxios || a.opera || a.silk || a.fluidapp || a.phantomjs || a.mobile &&
        !a.ios ? (delete a.safari, a.vivaldi && delete a.chrome) : a.safari = a.version && !a.rim_tablet_os ? a.version : {
          419: '2.0.4',
          417: '2.0.3',
          416: '2.0.2',
          412: '2.0',
          ...
          125: '1.2',
          85: '1.0'
        }[parseInt(a.safari, 10)] || a.safari) else if (a.msie || a.trident) if (a.opera || (a.ie = a.msie || a.rv), delete a.msie, delete a.android, a.windows_phone_os) a.windows_phone = a.windows_phone_os, delete a.windows_phone_os else {
        ...
        var d = '', a
        for (a in b) if (a && b.hasOwnProperty(a)) {
        ...
        var d = '', a
        for (a in b) a && b.hasOwnProperty(a) &&
